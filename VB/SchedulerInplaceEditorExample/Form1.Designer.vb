Namespace SchedulerInplaceEditorExample
    Partial Public Class Form1
        ...
        Private Sub InitializeComponent()
            ...
            Me.schedulerTestDataSet = New SchedulerInplaceEditorExample.SchedulerTestDataSet()
            Me.resourcesBindingSource = New System.Windows.Forms.BindingSource(Me.components)
            Me.appointmentsTableAdapter = New SchedulerInplaceEditorExample.SchedulerTestDataSetTableAdapters.AppointmentsTableAdapter()
            Me.resourcesTableAdapter = New SchedulerInplaceEditorExample.SchedulerTestDataSetTableAdapters.ResourcesTableAdapter()
            ...
            Me.schedulerControl1.OptionsView.UseInplaceEditor2016 = DevExpress.Utils.DefaultBoolean.True
            ...
            Me.Name = "Form1"
            Me.Text = "SchedulerInplaceEditorExample"
